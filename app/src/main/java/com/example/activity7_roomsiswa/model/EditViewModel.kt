...
import com.example.activity7_roomsiswa.ui.halaman.ItemEditDestination
...
class EditViewModel (
    ...
    init {
        viewModelScope.launch {
            siswaUiState = repositoriSiswa.getSiswaStream(itemId).filterNotNull().first().toUiStateSiswa(true)
        }
    }
